...
exports.buildRegistroAltaXml = buildRegistroAltaXml;
exports.buildRegistroAnulacionXml = buildRegistroAnulacionXml;
...
function formatNumber(value) {
    if (value === undefined)
        return undefined;
    return (0, utils_1.formatNumberForVeriFactu)(value);
}
/**
 * Build XML element with optional namespace
 */
function buildElement(name, value, indent = 0) {
 ...
 */
function buildPersona(persona, indent = 0) {
    const spaces = '  '.repeat(indent);
    let xml = '';
 ...
 */
function buildSistemaInformatico(sistema, indent = 0) {
    const spaces = '  '.repeat(indent);
 ...
 */
function buildDesglose(desglose, indent = 0) {
    const spaces = '  '.repeat(indent);
 ...
 */
function buildRegistroAltaXml(registro) {
 ...
 */
function buildRegistroAnulacionXml(registro) {
    let xml = '<?xml version="1.0" encoding="UTF-8"?>\n';
